...
gem 'stringex', '~> 2.5.2'
gem 'identity_cache', '~> 0.2.1'
# for identity_cache; on Mac install from console using: CXX=/usr/bin/clang++ gem install cityhash
gem 'cityhash', '~> 0.8.1'
gem 'zendesk_api'
gem 'dalli', '~> 2.7.1'
gem 'cancancan', '~> 1.9.1'
...
group :development do
  ...
  gem 'memory_profiler', '~> 0.9.6', require: false
